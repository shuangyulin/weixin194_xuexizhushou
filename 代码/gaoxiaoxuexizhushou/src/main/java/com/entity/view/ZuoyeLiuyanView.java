...
public class ZuoyeLiuyanView extends ZuoyeLiuyanEntity implements Serializable {
	...
	public ZuoyeLiuyanView() {

	}

	public ZuoyeLiuyanView(ZuoyeLiuyanEntity zuoyeLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zuoyeLiuyanEntity);
