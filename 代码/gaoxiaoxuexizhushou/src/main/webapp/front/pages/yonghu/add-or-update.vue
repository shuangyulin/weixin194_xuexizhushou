    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 16rpx #3CB371 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"20rpx","color":"#008761","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yonghuName" type="text" v-model="ruleForm.yonghuName" placeholder="学生姓名"></input>
            </view>
                <view
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                      class="title">学生身份证号</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 16rpx #3CB371 inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"20rpx","color":"#008761","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.yonghuIdNumber" type="text" v-model="ruleForm.yonghuIdNumber" placeholder="学生身份证号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.yonghuIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.yonghuIdNumber))) {
                    this.$utils.msg(`学生身份证号不能为空并且需要输入正确格式`);
                    return
                }
