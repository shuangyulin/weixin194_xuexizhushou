    		...
    		<view class="container">
                <view class="detail-content">
                    <view class="detail-list-item"
                          :style='{"boxShadow":"0 0 10rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#008761","backgroundColor":"#fff","borderRadius":"10rpx","borderWidth":"2rpx","borderStyle":"solid","height":"68rpx"}'>
                        <view class="lable"
                              :style='{"width":"auto","fontSize":"28rpx","color":"#008761","textAlign":"left"}'>
                            标题：</view>
                ...
                <view class="time-content"
                      :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","margin":"0 0 10rpx 0","borderColor":"#008761","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"solid","height":"100%"}'
                      style="height:auto !important;">
                    <view class="header" :style='{"color":"#008761","fontSize":"28rpx"}'>
                        内容
                    </view>
