    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="资源标题" prop="kechengName">
                       <el-input v-model="ruleForm.kechengName"
                                 placeholder="资源标题" clearable  :readonly="ro.kechengName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="资源标题" prop="kechengName">
                           <el-input v-model="ruleForm.kechengName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="资源类型" prop="kechengTypes">
                        <el-select v-model="ruleForm.kechengTypes" :disabled="ro.kechengTypes" placeholder="请选择资源类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="资源类型" prop="kechengValue">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="资源图片" prop="kechengPhoto">
                        <file-upload
                            tip="点击上传资源图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengPhoto" label="资源图片" prop="kechengPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengVideo" label="资源视频" prop="kechengVideo">
                        <file-upload
                            tip="点击上传资源视频"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.kechengVideo?ruleForm.kechengVideo:''"
                            @change="kechengVideoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengVideo" label="资源视频" prop="kechengVideo">
                            <video :src="ruleForm.kechengVideo" width="100" height="100" controls="controls">
                            </video>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="课件下载" prop="kechengFile">
                        <file-upload
                                tip="点击上传课件下载"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.kechengFile?ruleForm.kechengFile:''"
                                @change="kechengFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="课件下载" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.kechengFile"  >课件下载下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="资源详情" prop="kechengContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengContent" label="资源详情" prop="kechengContent">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            kechengVideoUploadChange(fileUrls){
                this.ruleForm.kechengVideo = fileUrls;
                this.addEditUploadStyleChange()
            },
            kechengFileUploadChange(fileUrls){
                this.ruleForm.kechengFile = fileUrls;
                this.addEditUploadStyleChange()
            },
